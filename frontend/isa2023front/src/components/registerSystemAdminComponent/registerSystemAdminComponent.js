...
import './registerSystemAdminComponent.css';
import { GetUserByEmail } from '../../services/UserService';
import authService from '../../services/auth.service.js';

const RegisterSystemAdminComponent = () => {
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <TextField color='secondary' size='small'  label="Password" variant="outlined" type="password" name="password" value={formData.password} InputProps={{ readOnly: true }} onChange={handleChange}/>
                <br />

                <TextField color='secondary' size='small'  label="Confirm Password" variant="outlined" type="password" name="confirmPassword" value={formData.confirmPassword} InputProps={{ readOnly: true }} onChange={handleChange}/>
                <br />
...
export default RegisterSystemAdminComponent;
